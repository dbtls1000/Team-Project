...
public class GamerController {
	...
	public String search(@RequestParam String pg_name, Model model) {
		List<ProgamerVO> pgList = pgService.findByNameNick(pg_name);
		
		model.addAttribute("SEARCH",pgList);
		model.addAttribute("BODY","GAMER_SEARCH");
		return "home";
	}
